...
/*
	Question : ACM 호텔 매니저 지우는 손님이 도착하는 대로 빈 방을 배정하고 있다. 고객 설문조사에 따르면 손님들은 호텔 정문으로부터 걸어서 가장 짧은 거리에 있는 방을 선호한다고 한다. 
	...
	Solution : 1. 단순한데 실수해서 2번이나 틀림..
			   2. 몫과 나머지를 이용하여 층수, 방번호를 get한다.
			   3. 방번호는 * 100을 해주어서 X0X 형식이 될 수 있도록 한다.
