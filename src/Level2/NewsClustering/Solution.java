 ...
 * Question : 
	...
	문자열 "FRANCE"와 "FRENCH"가 주어졌을 때, 이를 두 글자씩 끊어서 다중집합을 만들 수 있다. 각각 {FR, RA, AN, NC, CE}, {FR, RE, EN, NC, CH}가 되며, 
	교집합은 {FR, NC}, 합집합은 {FR, RA, AN, NC, CE, RE, EN, CH}가 되므로, 두 문자열 사이의 자카드 유사도 J("FRANCE", "FRENCH") = 2/8 = 0.25가 된다.
 * 
 * 
 * 	Solution : 1. str1을 2개씩 쪼개서 담는 공간이 하나 필요
 * 			   2. str2를 2개씩 쪼개서 담는 공간이 하나 필요
 * 			   3. 대소문자 변환해서 일치하면 교집합 갯수 ++
 * 			   4. 중복을 제거한 합집합 갯수 ++
 * 
 * */
